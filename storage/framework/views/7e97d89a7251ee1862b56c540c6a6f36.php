...
<div class="container py-5">
    ...
    <form method="POST" action="<?php echo e(route('gold.request.store')); ?>" id="goldForm">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="fullname" value="<?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateInstallment() {
        ...
        document.getElementById('modalFullName').innerText = '<?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?>';
